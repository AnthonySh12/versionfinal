...
public class PatTextBox extends JTextField {
    ...
    private void customizeComponent() {
        ...
        setForeground(SaludStyle.COLOR_FONT_LIGHT);  
        setCaretColor(SaludStyle.COLOR_CURSOR);    // Color del cursor
    ...
    public void setBorderRect() {
        Border lineBorder = BorderFactory.createLineBorder(SaludStyle.COLOR_BORDER);
    ...
    public void setBorderLine(){
        ...
        setBorder(  BorderFactory.createCompoundBorder(
                    ...
                    BorderFactory.createMatteBorder(0, 0, thickness, 0, SaludStyle.COLOR_BORDER) 
        ));
    }
}
